        ...
        <span key={lineIdx}>
          {parts.map((part, partIdx) =>
            part.toLowerCase() === highlight.toLowerCase() ? (
              <span key={partIdx} className="text-indigo-700">
                {part}
              </span>
            ) : (
              part
    ...
    <main className="flex flex-col">
      ...
      <section className="w-full bg-[#22303c] flex items-center justify-center py-10 lg:py-14">
        <div className="mx-auto w-full max-w-7xl px-6 py-14">
          <div className="relative w-full overflow-hidden border border-white/10 shadow-2xl bg-[#15202b]">
              ...
              >
                {[
                  ...
                  >
                    ...
                    <p className="text-sm text-white/75 leading-relaxed w-full">
                      {card.body}
                    </p>
                  </article>
                ))}
      ...
      <section className="w-full bg-[#192734]">
        <div className="mx-auto w-full max-w-7xl px-6 py-14">
          <div className="text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-base text-white/75 text-center px-4">
